...
from tables import birth_b4_death_us3, user_story_4
...
class Test(unittest.TestCase):
    ...
    def test_us3(self):
        ...
        self.assertEqual(birth_b4_death_us3(datetime.datetime.strptime('1900-11-2','%Y-%m-%d').date(),datetime.datetime.strptime('2000-11-2','%Y-%m-%d').date(), "Nicole"), True)
        self.assertEqual(birth_b4_death_us3(datetime.datetime.strptime('2000-2-11','%Y-%m-%d').date(),datetime.datetime.strptime('1900-2-11','%Y-%m-%d').date(), "Caroline"), False)
        self.assertEqual(birth_b4_death_us3(datetime.datetime.strptime('3000-11-2','%Y-%m-%d').date(),datetime.datetime.strptime('2000-11-2','%Y-%m-%d').date(), "Michayla"), False)
        self.assertEqual(birth_b4_death_us3(datetime.datetime.strptime('1999-11-2','%Y-%m-%d').date(),datetime.datetime.strptime('1999-11-2','%Y-%m-%d').date(), "Elena"), True)
        self.assertEqual(birth_b4_death_us3(datetime.datetime.strptime('1998-11-2','%Y-%m-%d').date(),datetime.datetime.strptime('3000-11-2','%Y-%m-%d').date(), "David"), False)
